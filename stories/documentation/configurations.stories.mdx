...
**It is recommended to use web font instead of local font as Nextjs come with built-in [Font Optimization](https://nextjs.org/docs/basic-features/font-optimization)**
